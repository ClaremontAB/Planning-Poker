...
steroids.config.name = "Planning-Poker-App"

# -- Initial Location --
#steroids.config.location = "http://localhost/index.html"
#steroids.config.location = "http://localhost/views/pokerCards/index.html"
...
steroids.config.tabBar.tabs = [
   ...
   {
     title: "Game on!"
     icon: "icons/gameon.png"
     location: "http://localhost/views/pokerCards/index.html"
   },
   {
     title: "Settings"
